    ...
    <div className="container mx-auto mt-16 p-6 md:pb-12 md:mt-24 bg-white">
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-8 md:gap-12">
        ...
        <div className="">
          ...
          <ul className="space-y-4 font-montserrat text-sm pb-5 md:pb-8 md:pe-4 xxl:text-lg xl:pe-2">
            <li>
          ...
          <Link href="/services">
            <button className="bg-uRed text-white px-6 py-2 mt-5 md:mt-1 rounded-full hover:bg-red-600">
              Donate
            </button>
          </Link>
        </div>
